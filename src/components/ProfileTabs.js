...
export default function ProfileTabs({userId,active}) {
  ...
  return (
    <div className="mt-4 md:mt-10 flex justify-between">
      <Link href={`/profile/${userId}/posts`} className={active === 'posts' ? activeTabClasses : tabClasses}>
        ...
        <span className="sm:block">Записи</span>
      </Link>
      <Link href={`/profile/${userId}/photos`} className={active === 'photos' ? activeTabClasses : tabClasses}>
        ...
        <span className="sm:block">Полка</span>
      </Link>
      <Link href={`/profile/${userId}/about`} className={active === 'about'? activeTabClasses : tabClasses}>
        ...
        <span className="sm:block">Подписки</span>
      </Link>
      {/* <Link href={`/profile/${userId}/photos`} className={active === 'photos' ? activeTabClasses : tabClasses}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">

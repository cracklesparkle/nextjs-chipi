                        ...
                        <div className="relative overflow-hidden rounded-md p-3">
                            ...
                            <div className="flex flex-col my-4">
                                ...
                                <div className='my-1 flex flex-row justify-between'>
                                    <Link href={'/book'}>
                                        <div className="h-32 w-24 bg-blue-200 rounded-md"></div>
                            ...
                            <div className="flex flex-col my-4">
                                ...
                                <div className='my-1 flex flex-row justify-between'>
                                    <Link href={'/book'}>
                                        <div className="h-32 w-24 bg-green-500 rounded-md"></div>
                                        <div className="text-center font-semibold">Название</div>
                                    </Link>
                                    <Link href={'/book'}>
                                        <div className="h-32 w-24 bg-green-500 rounded-md"></div>
                            ...
                            <div className="flex flex-col my-4">
                                ...
                                <div className='my-1 flex flex-row justify-between'>
                                    <Link href={'/book'}>
                                        <div className="h-32 w-24 bg-teal-500 rounded-md"></div>
                                        <div className="text-center font-semibold">Название</div>
                                    </Link>
                                    <Link href={'/book'}>
                                        <div className="h-32 w-24 bg-teal-500 rounded-md"></div>
